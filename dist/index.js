...
var require_next_tick = __commonJS({
  "node_modules/catering/next-tick.js"(exports, module) {
  ...
  "node_modules/abstract-level/abstract-chained-batch.js"(exports) {
    ...
    var AbstractChainedBatch = class {
      ...
      put(key, value, options) {
        ...
        this[kOperations].push({ ...original2, type: "put", key, value });
        return this;
      }
      ...
      del(key, options) {
        ...
        this[kOperations].push({ ...original2, type: "del", key });
        return this;
      }
      _del(key, options) {
      }
...
var require_next_tick2 = __commonJS({
  "node_modules/abstract-level/lib/next-tick.js"(exports, module) {
    "use strict";
...
var require_binding = __commonJS({
  "node_modules/classic-level/binding.js"(exports, module) {
...
var require_chained_batch = __commonJS({
  "node_modules/classic-level/chained-batch.js"(exports) {
    "use strict";
...
var require_iterator = __commonJS({
  "node_modules/classic-level/iterator.js"(exports) {
    "use strict";
      ...
      _next(callback) {
        if (this[kPosition] < this[kCache].length) {
          ...
          if (this[kFirst]) {
            ...
            binding.iterator_nextv(this[kContext], 1e3, this[kHandleNext]);
          }
        }
      }
...
var require_classic_level = __commonJS({
  "node_modules/classic-level/index.js"(exports) {
    "use strict";
    ...
    var ClassicLevel2 = class extends AbstractLevel {
      ...
      _open(options, callback) {
        if (options.createIfMissing) {
          fs2.mkdir(this[kLocation], { recursive: true }, (err) => {
            if (err)
              return callback(err);
    ...
    exports.ClassicLevel = ClassicLevel2;
  }
});
...
var import_nedb_promises, import_classic_level, HIERARCHY, TYPE_COLLECTION_MAP;
var init_package = __esm({
  "node_modules/@foundryvtt/foundryvtt-cli/lib/package.mjs"() {
    import_nedb_promises = __toESM(require_nedb_promises(), 1);
    init_source();
    init_js_yaml();
    import_classic_level = __toESM(require_classic_level(), 1);
    HIERARCHY = {
      actors: {
        items: [],
        effects: []
